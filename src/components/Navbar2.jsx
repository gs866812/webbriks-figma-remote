    ...
    <React.Fragment>
      ...
      >
        <MenuHandler>
          ...
          >
            <ListItem
              className="flex items-center gap-2 py-2 pr-4 font-medium hover:bg-orange-400"
  ...
  return (
    <List className="mt-4 p-0 lg:mb-0 lg:mt-0 lg:flex-row lg:p-1">
      <Typography
        ...
        color="black"
      >
        <ListItem className={`flex items-center gap-2 py-2 pr-4 hover:bg-orange-400 ${currentPath === '/' ? 'bg-orange-400 text-gray-800' : ''}`}>Home</ListItem>
      </Typography>
      <Typography
        as="a"
        href="/about"
        ...
        color="black"
      >
        <ListItem className={`flex items-center gap-2 py-2 pr-4 hover:bg-orange-400 ${currentPath === '/about' ? 'bg-orange-400 text-gray-800' : ''}`}>About</ListItem>
      </Typography>
      <NavListMenu />
      <Typography
        as="a"
        ...
        color="black"
      >
        <ListItem className={`flex items-center gap-2 py-2 pr-4 hover:bg-orange-400 ${currentPath === '/portfolio' ? 'bg-orange-400 text-gray-800' : ''}`}>
          Portfolio
        </ListItem>
      </Typography>
      <Typography
        ...
        color="black"
      >
        <ListItem className={`flex items-center gap-2 py-2 pr-4 hover:bg-orange-400 ${currentPath === '/contact' ? 'bg-orange-400 text-gray-800' : ''}`}>
          Contact
        </ListItem>
      </Typography>
    </List>
...
export function NavigationbarWithDropdownMultilevelMenu2() {
    ...
    <div className="bg-gray-100">
      <Navbar className="shadow-none w-full rounded-none border-none mx-auto bg-transparent ">
        <div className="flex items-center justify-between">
          <span className='text-orange-500 font-bold text-2xl'>myLogo</span>
          ...
          <div className="hidden md:block">
            <Link
              href="/get-quote"
              className="bg-orange-400 text-gray-800 px-4 py-2 rounded hover:bg-orange-500 transition"
            >
              Get a Quote
            </Link>
          </div>
        ...
        <Collapse open={openNav}>
          ...
          <Link
              href="/get-quote"
              className="bg-orange-400 text-gray-600 px-2 py-1 rounded hover:bg-orange-500 transition"
            >
              Get a Quote
            </Link>
          </div>
