        ...
        <React.Fragment>
            ...
            >
                ...
                <MenuHandler>
                    ...
                    >
                        <ListItem
                            className={`flex items-center gap-2 py-2 pr-4 hover:bg-transparent hover:text-orange-500 font-medium bg-transparent ${
            ...
            <div className="block lg:hidden">
              ...
              <MenuItem>
                ...
                />
                    ...
                    <MenuItem className="bg-gray-500">
                        <a href="/services/graphics-design">Graphics design</a>
                    </MenuItem>
                    <MenuItem className="bg-gray-500">
                        <a href="/services/photo-editing">Photo editing</a>
...
function NavList() {
    ...
    return (
        <List className="mt-4 p-0 lg:mb-0 lg:mt-0 lg:flex-row lg:p-1">
            ...
            >
                <ListItem
                    className={`flex items-center gap-2 py-2 pr-4 hover:bg-[#FEF9EF] hover:text-orange-500 ${
                        currentPath === '/' ? 'text-orange-500' : ''
                    }`}
                >
                    Home
                </ListItem>
            ...
            >
                <ListItem
                    className={`flex items-center gap-2 py-2 pr-4 hover:bg-[#FEF9EF] hover:text-orange-500 ${
                        currentPath === '/about' ? 'text-orange-500' : ''
                    }`}
                >
                    About
                </ListItem>
      ...
      >
        <ListItem className={`flex items-center gap-2 py-2 pr-4 hover:bg-[#FEF9EF] hover:text-orange-500 ${currentPath === '/services' ? 'text-orange-500' : ''}`}>Services</ListItem>
            ...
            >
                <ListItem
                    className={`flex items-center gap-2 py-2 pr-4 hover:bg-[#FEF9EF] hover:text-orange-500 ${
                        currentPath === '/portfolio' ? 'text-orange-500' : ''
                    }`}
                >
                    Portfolio
                </ListItem>
            ...
            >
                <ListItem
                    className={`flex items-center gap-2 py-2 pr-4 hover:bg-[#FEF9EF] hover:text-orange-500 ${
                        currentPath === '/contact' ? 'text-orange-500' : ''
                    }`}
                >
                    Contact
                </ListItem>
